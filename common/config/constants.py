...
NEON_PROXY_MINOR_VER = 13
NEON_PROXY_BUILD_VER = 0
NEON_PROXY_VER = f"{NEON_PROXY_MAJOR_VER}.{NEON_PROXY_MINOR_VER}.{NEON_PROXY_BUILD_VER}"

_REVISION = "NEON_PROXY_REVISION_TO_BE_REPLACED"
NEON_PROXY_PKG_VER = f"Neon-Proxy/v{NEON_PROXY_VER}-dev-{_REVISION}"
