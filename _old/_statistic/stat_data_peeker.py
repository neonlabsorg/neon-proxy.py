...
class StatDataPeeker:
    def __init__(self, cfg: Config, stat_srv: IHealthStatService):
        self._stat_service = stat_srv
        self._sol_client = SolInteractor(cfg)
        self._db_conn = DBConnection(cfg)
    ...
    def _stat_solana_node_health(self) -> None:
        is_healthy = self._sol_client.is_healthy()
