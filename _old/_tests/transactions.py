from common_neon.config import EVM_PROGRAM_ID_STR
...
wormhole_redeem_write_tx = {
    ...
    'transaction': {
        'message': {
            ...
            'recentBlockhash': 'J4xmNY2z3CKH9yTczXFCUKCPe174rABaAEHHMxuEKg8T'
        },
        'signatures': [
            '33xDABKhpnnctKYbhgMLh98F6C7DnutgUYfpun2z222QaoG52m9JgsQaCV4Ya2mGGhX6biJjX8DA1g4WpxDcAeVX'
        ]
    },
    'version': 'legacy'
}
        ...
        'innerInstructions': [
            {
                ...
                'instructions': [
                    ...
                    {
                        'accounts': [0, 4, 3],
                        'data': '3ipZWe5NXrcyZzYVvozZSqcyoPxBUdrFofQTeikDpFcd8j1RfRcEtbN6YAXsBEjdEZ3DGXRJbsdtLpZVcfXAdnturozAWkLNRwj3ma6n9QW6n8FuZNWBNpFr2DA7Vzh47yykchMNuPZgg97vG8VRRq6MA2En2PoWk7GtooZ3W',
                        'programIdIndex': 13
                    }
                ]
            }
