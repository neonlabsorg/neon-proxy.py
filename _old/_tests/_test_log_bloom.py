...
from common_neon.utils.helpers import hex_to_bytes, hex_to_int
from common_neon import NeonTxResultInfo
...
test_tx_res_info = NeonTxResultInfo(
    slot=hex_to_int('0x11e2e76'),
    block_hash='0x807dd50334871b7c85ff551c1c7c082670029618973dc2723e74f6df936326ab',
    tx_idx=hex_to_int('0x7a'),
    neon_sig='0xe6f0782c013a37c3450e100508244353496cf6a0d1581dac4392b643463d04c2',
    status=hex_to_int('0x1'),
    gas_used=hex_to_int('0x168d7'),
    sum_gas_used=hex_to_int('0xa7dc37'),
    event_list=tuple([
        NeonLogTxEvent(
            NeonLogTxEvent.Type.Log,
            is_hidden=False,
            address=hex_to_bytes('0xde30da39c46104798bb5aa3fe8b9e0e1f348163f'),
            topic_list=tuple([
                hex_to_bytes(x)
                for x in (
            ...
            data=hex_to_bytes('0x00000000000000000000000000000000000000000000000046c6d6faa27e0000'),
            slot=hex_to_int('0x11e2e76'),
            block_hash='0x807dd50334871b7c85ff551c1c7c082670029618973dc2723e74f6df936326ab',
            neon_sig='0xe6f0782c013a37c3450e100508244353496cf6a0d1581dac4392b643463d04c2',
            neon_tx_idx=hex_to_int('0x7a'),
            neon_tx_log_idx=hex_to_int('0x105'),
        ),
        NeonLogTxEvent(
            NeonLogTxEvent.Type.Log,
            is_hidden=False,
            ...
            neon_sig='0xe6f0782c013a37c3450e100508244353496cf6a0d1581dac4392b643463d04c2',
            neon_tx_idx=hex_to_int('0x7a'),
            neon_tx_log_idx=hex_to_int('0x106'),
        ),
        NeonLogTxEvent(
            NeonLogTxEvent.Type.Log,
            is_hidden=False,
            address=hex_to_bytes('0x0e3efd5be54cc0f4c64e0d186b0af4b7f2a0e95f'),
            topic_list=tuple([
                hex_to_bytes(x)
                for x in (
            ...
            neon_sig='0xe6f0782c013a37c3450e100508244353496cf6a0d1581dac4392b643463d04c2',
            neon_tx_idx=hex_to_int('0x7a'),
            neon_tx_log_idx=hex_to_int('0x107'),
        ),
    ])
)
