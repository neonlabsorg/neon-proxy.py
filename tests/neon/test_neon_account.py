...
from common.neon.address import NeonAddress, NeonAddressField, eth_keys
from common.utils.format import hex_to_bytes


class TestNeonAddress(unittest.TestCase):
    def test_from_dict(self):
        ...
        account1 = NeonAddress.from_dict(raw_dict)
        ...
        account2 = NeonAddress.from_dict(account1)
        ...
        account3 = NeonAddress.from_dict(raw_dict2)
        ...
        account4 = NeonAddress.from_dict(raw_dict)
        with self.assertRaises(AssertionError):
            _ = account4.private_key

        raw_dict5 = dict()
        account5 = NeonAddress.from_dict(raw_dict5)
    ...
    def test_from_raw(self):
        ...
        account1 = NeonAddress.from_raw(public_key, 10)
        self.assertFalse(account1.is_empty)

        account2 = NeonAddress.from_raw(account1, account1.chain_id)
        self.assertIs(account1, account2)

        account3 = NeonAddress.from_raw(account1, account1.chain_id + 1)
        self.assertIsNot(account1, account3)

        account4 = NeonAddress.from_raw("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f", 12)
        self.assertFalse(account4.is_empty)

        account5 = NeonAddress.from_raw(hex_to_bytes("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f"), 13)
        self.assertFalse(account5.is_empty)

        account6 = NeonAddress.from_raw(bytearray(hex_to_bytes("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f")), 14)
        self.assertFalse(account6.is_empty)

        # wrong size
        with self.assertRaises(ValueError):
            _ = NeonAddress.from_raw("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f12", 15)

        with self.assertRaises(ValueError):
            _ = NeonAddress.from_raw("0xde30da39c46104798bb5aa3fe8b9e0e1f34816", 16)

        with self.assertRaises(ValueError):
            _ = NeonAddress.from_raw(hex_to_bytes("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f12"), 17)

        with self.assertRaises(ValueError):
            _ = NeonAddress.from_raw(hex_to_bytes("0xde30da39c46104798bb5aa3fe8b9e0e1f34816"), 18)

        # wrong type
        with self.assertRaises(ValueError):
            _ = NeonAddress.from_raw(1234, 1234)

    def test_random(self):
        account = NeonAddress.random(12)
    ...
    def test_from_private_key(self):
        ...
        account = NeonAddress.from_private_key(private_key, 12)
        self.assertFalse(account.is_empty)
        self.assertIsNotNone(account.private_key)

    def test_to_dict(self):
        account1 = NeonAddress.random(12)
        ...
        account2 = NeonAddress.from_raw("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f", 14)
    ...
    def test_is_empty(self):
        ...
        account3 = NeonAddress.from_raw(bytes(), 15)
    ...
    def test_to_bytes(self):
        ...
        account2 = NeonAddress.from_raw(None, 67)
    ...
    def test_to_address(self):
        account1 = NeonAddress.random(45)
        ...
        account2 = NeonAddress.from_raw(None, 76)
    ...
    def test_to_checksum_address(self):
        ...
        with self.assertRaises(ValueError):
            _ = NeonAddress.from_private_key(bytes(31), 101)

    def test_equal(self):
        account1 = NeonAddress.random(124)
        account2 = NeonAddress.random(124)
        self.assertNotEqual(account1, account2)

    def test_pydantic(self):
        class TestPydanticModel(BaseModel):
            account: NeonAddressField

        src1_model = TestPydanticModel(account=NeonAddress.random(12))
        ...
        src2_model = TestPydanticModel(account=NeonAddress.from_raw("0xde30da39c46104798bb5aa3fe8b9e0e1f348163f", 1))
    ...
    def test_str(self):
        account1 = NeonAddress.random(12)
        account2 = NeonAddress.from_raw(account1, 16)
    ...
    def test_hash(self):
        account1 = NeonAddress.random(15)
        account2 = NeonAddress.from_raw(account1, 16)
        ...
        account3 = NeonAddress.from_raw(account1.to_address(), account1.chain_id)
