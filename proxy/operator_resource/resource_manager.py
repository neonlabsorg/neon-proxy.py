...
from common.solana_rpc.transaction_list_sender import NeonSolTxListSender
...
class OpResourceMng(OpResourceComponent):
    ...
    async def _send_tx_list(self, signer: SolSigner, tx_list: Sequence[SolTx]) -> bool:
        ...
        tx_sender = NeonSolTxListSender(self._cfg, self._stat_client, sol_watch, tx_signer)
        try:
